...
export default function AttendanceDashboard() {
  const [students, setStudents] = useState<Student[]>([
    { id: '1', rollNumber: '001', name: 'Alice Johnson', lastAbsentDate: '2024-01-15', consecutiveAbsences: 0, attendancePercentage: 95 },
    { id: '2', rollNumber: '002', name: 'Bob Smith', lastAbsentDate: '2024-01-16', consecutiveAbsences: 2, attendancePercentage: 78 },
    { id: '3', rollNumber: '003', name: 'Charlie Brown', lastAbsentDate: '2024-01-14', consecutiveAbsences: 0, attendancePercentage: 88 },
    { id: '4', rollNumber: '004', name: 'Diana Prince', lastAbsentDate: '2024-01-16', consecutiveAbsences: 1, attendancePercentage: 92 },
    { id: '5', rollNumber: '005', name: 'Ethan Hunt', lastAbsentDate: '2024-01-13', consecutiveAbsences: 0, attendancePercentage: 97 },
    { id: '6', rollNumber: '006', name: 'Fiona Green', lastAbsentDate: '2024-01-16', consecutiveAbsences: 3, attendancePercentage: 65 },
  ])

  const [absenceNotifications, setAbsenceNotifications] = useState<AbsenceNotification[]>([
    { studentId: '2', studentName: 'Bob Smith', rollNumber: '002', daysSinceAbsent: 1, consecutiveAbsences: 2 },
    { studentId: '4', studentName: 'Diana Prince', rollNumber: '004', daysSinceAbsent: 1, consecutiveAbsences: 1 },
    { studentId: '6', studentName: 'Fiona Green', rollNumber: '006', daysSinceAbsent: 1, consecutiveAbsences: 3 },
  ])
  ...
  const getRiskLevel = (consecutiveAbsences: number) => {
